...
public class ClientTsp extends Client<List<Integer>> implements Serializable {
  ...
  //                  { 5, 4 },
     ...
     */
    public ClientTsp(String ip) throws RemoteException, NotBoundException, MalformedURLException {
        super("Euclidean TSP", ip, new TspJob(CITIES));
        System.out.println("Number of cities: " + CITIES.length);
    }

    public static void main( String[] args ) throws RemoteException, MalformedURLException, NotBoundException {
        System.setSecurityManager(new SecurityManager());
        final ClientTsp client = new ClientTsp("localhost");
        client.add( client.getLabel(client.runJob().toArray(new Integer[0])));
    }
