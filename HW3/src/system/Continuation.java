...
public class Continuation implements Serializable{
     ...
     * @param closureId: if this instance is root, id should be set to "-1". Otherwise closure id's
     *                 should be generated by Closures. As such the closure id should be supplied my an instance of Closure.
